              ...
              <Form method="post" onSubmit={handleSave}>
                <s-stack direction="block" gap="base">
                  ...
                  <s-text-field
                    ...
                    value={config.linkUrl}
                    onChange={(e) =>
                      setConfig((c) => ({ ...c, linkUrl: e.currentTarget.value }))
                    }
                    autocomplete="off"
                    placeholder="https://"
                  />
                  ...
                  <s-select
                    ...
                    value={config.fontFamily}
                    onChange={(e) =>
                      setConfig((c) => ({ ...c, fontFamily: e.currentTarget.value }))
                    }
                  >
                    <s-option value="inherit">Inherit theme</s-option>
                    <s-option value="system">System UI</s-option>
                  ...
                  <s-grid gridTemplateColumns="1fr 1fr" gap="base">
                    ...
                    <s-select
                      ...
                      value={config.fontWeight}
                      onChange={(e) =>
                        setConfig((c) => ({ ...c, fontWeight: e.currentTarget.value }))
                      }
                    >
                      <s-option value="400">400</s-option>
                      <s-option value="500">500</s-option>
                  ...
                  <s-select
                    ...
                    value={config.textAlign}
                    onChange={(e) =>
                      setConfig((c) => ({ ...c, textAlign: e.currentTarget.value }))
                    }
                  >
                    <s-option value="left">Left</s-option>
                    <s-option value="center">Center</s-option>
                  ...
                  <s-select
                    ...
                    value={config.shadow}
                    onChange={(e) =>
                      setConfig((c) => ({ ...c, shadow: e.currentTarget.value }))
                    }
                  >
                    <s-option value="none">None</s-option>
                    <s-option value="subtle">Subtle</s-option>
